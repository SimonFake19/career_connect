...
@section('heading', 'Job Categories Page Content')
                ...
                <div class="card-body">
                    <form action="{{route('admin_job_category_page_update')}}" method="post">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea name="meta_description" class="form-control h_100" id="" cols="30" rows="10">{{$page_job_category_data->meta_description}}</textarea>
                        </div>
