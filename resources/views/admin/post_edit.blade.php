                ...
                <div class="card-body">
                    <form action="{{ route('admin_post_update', $post_single->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea name="short_description" class="form-control h_100" id="" cols="30" rows="10">{{$post_single->short_description}}</textarea>
                        </div>

                        <div class="form-group mb-3">
                            <label>Description *</label>
                            <textarea name="description" class="form-control editor" id="" cols="30" rows="10">{{$post_single->description}}</textarea>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea name="meta_description" class="form-control h_100" id="" cols="30" rows="10">{{$post_single->meta_description}}</textarea>
                        </div>
