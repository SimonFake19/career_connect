                ...
                <div class="card-body">
                    <form action="{{ route('admin_post_store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea name="short_description" class="form-control h_100" id="" cols="30" rows="10">{{old('short_description')}}</textarea>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea name="meta_description" class="form-control h_100" id="" cols="30" rows="10">{{old('meta_description')}}</textarea>
                        </div>
