...
<style>
    ...
    .why-choose-image {
        background-image: url("{{ asset('uploads/'.$home_page_data->why_choose_background) }}");
    }

    .testimonial-image {
        background-image: url("{{ asset('uploads/'.$home_page_data->testimonial_background) }}");
    }
</style>
<!-- {{ $home_page_data->background }} -->
                                ...
                                <div class="row">
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <input type="text" name="" class="form-control" placeholder="{{ $home_page_data->job_title }}" />
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="form-group">
...
<div class="why-choose why-choose-image">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="heading">
...
<div class="testimonial testimonial-image">
    <div class="bg"></div>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
